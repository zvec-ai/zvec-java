package io.zvec.binding.examples;

import io.zvec.binding.*;
 ...
 * <p>Run with:
 * <pre>
 * java -Djna.library.path=../../zvec/build/lib -cp target/zvec-java-1.0.0.jar io.zvec.binding.examples.BasicExample
 * </pre>
 */
