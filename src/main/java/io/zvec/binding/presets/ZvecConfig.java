package io.zvec.binding.presets;
 ...
 * {@code io.zvec.binding.ZvecNative}. The JavaCPP {@code Generator} then emits
 ...
 */
@Properties(
        target = "io.zvec.binding.ZvecNative",
        value = @Platform(
...
public class ZvecConfig implements InfoMapper {
    ...
    static {
        ...
        // to io.zvec.binding.NativeLoader) so it stays safe during the JavaCPP
